...
plot(range(subdata$DateTime), range(c(subdata$Sub_metering_1, subdata$Sub_metering_2, subdata$Sub_metering_3)), type='n', ylab="Energy sub metering", xlab="")
