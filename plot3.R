...
## The 3rd plot - the line plots of metering variables

png('plot3.png', width=480,height=480, bg="transparent")
plot(range(subdata$DateTime), range(c(subdata$Sub_metering_1, subdata$Sub_metering_2, subdata$Sub_metering_3)), type='n', ylab="Energy sub metering", xlab="", bg="transparent")
